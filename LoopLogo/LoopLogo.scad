...
img_file      = "c:/users/jayongg/downloads/loop_heightmap2.png";  // preprocessed mask+height
max_xy_mm     = 120;                   // longest XY dimension
max_height_mm = 14;                    // peak height (tune 10–16 mm as desired)
base_clip_mm  = 0.4;                   // ensures perfectly flat base
...
// Uniform scale: assume source heightmap ~100 units square
uniform_scale = max_xy_mm / 100;
