...
module tower_pair(x_right) {
  tower_scaled(x_right, _tower_front_y0_orig, _tower_front_len_orig, tower_length);
  tower_scaled(x_right, _tower_back_y0_orig,  _tower_back_len_orig,  tower_length);
}
